## Overview
This repository contains a Jokes Recommender System that utilizes user ratings of jokes to recommend personalized jokes to users based on similarity scores.
## Dataset Information
